const sectionTemplateUno = `
<div class="bd-container">
<div class="progetto-container progetto-layoutUno">
    <div class="progetto-itemGrid">
        <img src="IMG_SRC_1">
        <div class="progetto-titoloProgetto">PROGETTO_TITOLO_1</div>
        <button class="progetto-pulsante button" id="button-ID_1">Scopri di più</button>
    </div>
    <div class="progetto-itemGrid">
        <img src="IMG_SRC_2">
        <div class="progetto-titoloProgetto">PROGETTO_TITOLO_2</div>
        <button class="progetto-pulsante button" id="button-ID_2">Scopri di più</button>
    </div>
</div>
</div>
`;

const sectionTemplateDue = `
<div class="bd-container">
<div class="progetto-container progetto-layoutDue">
    <div class="progetto-itemGrid">
        <img src="IMG_SRC_1">
        <div class="progetto-titoloProgetto">PROGETTO_TITOLO_1</div>
        <button class="progetto-pulsante button" id="button-ID_1">Scopri di più</button>
...
async function fetchProjects(startIndex, count) {
    const response = await fetch(`https://backendcfs.vercel.app/api/projects?start=${startIndex}&count=${count}`);
    if (response.ok) {
